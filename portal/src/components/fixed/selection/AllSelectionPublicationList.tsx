        ...
        <>
            <ul>
                {publicationList && publicationList.length > 0 ?
                        ...
                        return (
                            ...
                            >
                                <div className=" w-full py-2 px-5 ">
                                    <h1 className="font-medium text-gray-600">{item.positionTitle}</h1>
                                    <p className="text-sm text-gray-500">Posting Date: {dayjs(item.postingDate).format('MMMM d, YYYY')}</p>
                    ...
                    <>
                        <div className="w-full text-3xl font-medium flex flex-col text-gray-600 justify-center place-items-center justify-items-center h-[9.5rem]">
