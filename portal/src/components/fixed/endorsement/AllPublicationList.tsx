                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center hover:bg-indigo-50 justify-between w-full py-2 px-5 ">
                                    ...
                                    {item.hasSelected === 0 ? (
                                        <Button btnLabel="SET" icon={<HiPlusCircle />} className='w-28' light shadow iconPlacement="start" onClick={() => onSelect(item, 'create')} />
                                    ) : (
                                        <Button btnLabel="View" icon={<HiEye />} className='w-28' shadow iconPlacement='start' onClick={() => onSelect(item, 'view')} />
                                    )}
                                </div>
                            </li>
                        );
