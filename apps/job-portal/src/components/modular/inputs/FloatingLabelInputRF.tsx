    ...
    <>
      ...
      >
        <div className="relative">
          ...
          px-1  text-xs font-normal ${isError ? 'text-red-700' : 'text-gray-600'} transition-all peer-placeholder-shown:-inset-y-[0.85rem] peer-placeholder-shown:left-0 peer-placeholder-shown:bg-transparent peer-placeholder-shown:px-1 peer-placeholder-shown:text-sm
