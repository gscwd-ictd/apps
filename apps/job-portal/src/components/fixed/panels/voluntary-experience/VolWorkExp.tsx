...
export const VolWorkExp = (): JSX.Element => {
  ...
  // remove action modal
  const openRemoveActionModal = (volWork: VoluntaryWork, volWorkIdx: number) => {
      ...
      <Card
        ...
        children={
          <>
            ...
            />
            <ModalAction isOpen={removeVolWorkIsOpen} setIsOpen={setRemoveVolWorkIsOpen} action={() => handleRemoveWork(volWorkToRemove)} />
                      ...
                      {voluntaryWork.map((work: VoluntaryWork, workIdx: number) => {
                        return (
                          ...
                          >
                            ...
                            <TableDimension isText={true} label={work.position} className="select-none" />
                            <TableDimension isText={true} className="" label={work.from} />
                            <TableDimension isText={true} className="" label={work.to ? work.to : 'Ongoing'} />
                            <TableDimension isText={true} className="" label={work.numberOfHours ? work.numberOfHours : 'N/A'} />
                            <TableDimension
                              isText={false}
                              className="select-none px-2 text-center"
                              tableDimension={
                                <>
                                  <DeleteButton action={() => openRemoveActionModal(work, workIdx)} />
                                </>
                              }
                            />
                          </tr>
