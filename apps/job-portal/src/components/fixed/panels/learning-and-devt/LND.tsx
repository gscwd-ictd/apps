...
export const LearningNDevt = (): JSX.Element => {
  ...
  const setDeletedLearningDevelopments = usePdsStore((state) => state.setDeletedLearningDevelopments)
        ...
        children={
          <>
            <Modal
              ...
              subtitle={
                <>
                  Start from the most recent L&D/training program and include only the relevant L&D/training taken for the last five (5)
                  years for Division Chief/Executive/Managerial positions <br></br> Please fill-out all required fields ({' '}
              ...
              children={
                <>
                  <div className="mb-5 gap-4 p-5">
                    ...
                    <div className="mt-10 grid-cols-2 gap-8 sm:block lg:flex">
                      <div className="col-span-1 mb-10 w-full">
                        <InputReactForm
                          id="lndfrom"
                          name="lndfrom"
                          label="From"
            ...
            />
            <ModalAction isOpen={removeLndIsOpen} setIsOpen={setRemoveLndIsOpen} action={() => handleRemoveTraining(lndToRemove)} />
                      ...
                      {learningDevelopment.map((training: LearningDevelopment, trainingIdx: number) => {
                        return (
                          ...
                          >
                            ...
                            <TableDimension isText={true} label={training.conductedBy} className="select-none pr-1" />
                            <TableDimension isText={true} className="pr-1" label={training.type} />
                            <TableDimension isText={true} className="pr-1" label={training.from} />
                            <TableDimension isText={true} className="pr-1" label={training.to} />
                            <TableDimension isText={true} className="pr-1" label={training.numberOfHours} />
                            <TableDimension
                              isText={false}
                              className="select-none px-2 text-center"
                              tableDimension={
                                <>
                                  <DeleteButton action={() => openRemoveActionModal(training, trainingIdx)} />
                                </>
                              }
                            />
                          </tr>
