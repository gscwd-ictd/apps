...
import { Organization } from 'apps/job-portal/utils/types/data/other-info.type';
...
export const OIOrgs = (): JSX.Element => {
  ...
  const [removedOrganizations, setRemovedOrganizations] =
    useState<Organization>({} as Organization);
  const deletedOrganizations = usePdsStore(
    (state) => state.deletedOrganizations
  );
  const setDeletedOrganizations = usePdsStore(
    (state) => state.setDeletedOrganizations
  );
    ...
    <>
      ...
      >
        <>
          ...
          <ModalAction
            isOpen={removeOrgIsOpen}
            setIsOpen={setRemoveOrgIsOpen}
            action={() => handleRemoveTitle(orgToRemove)}
          />
                              ...
                              <TableDimension
                                ...
                                tableDimension={
                                  <>
                                    <DeleteButton
                                      action={() =>
                                        openRemoveActionModal(org, orgIdx)
                                      }
                                    />
                                  </>
                                }
