      ...
      <Card
        ...
        children={
          <>
            ...
            />
            <ModalAction isOpen={removeSkillIsOpen} setIsOpen={setRemoveSkillIsOpen} action={() => handleRemoveTitle(skillToRemove)} />
            {skills.length === 0 ? (
              <>
                <NoDataVisual />
              </>
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableDimension
                                ...
                                tableDimension={
                                  <>
                                    <DeleteButton action={() => openRemoveActionModal(skill, skillIdx)} />
                                  </>
                                }
                              />
                            </tr>
