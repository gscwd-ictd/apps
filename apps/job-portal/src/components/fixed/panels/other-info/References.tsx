          ...
          <>
            {refError ? (
              <div
                ...
                ref={refRef}
              >
                <p className="w-full px-10 text-center uppercase not-italic text-white ">Incomplete References</p>
              </div>
            ) : (
              <></>
            )}
            ...
            <Modal
              ...
              subtitle={
                <>
                  Indicate the FULL name of references with the format SURNAME, FIRST NAME MI, their addresses and respective telephone
                  numbers. <br></br>Please fill-out all required fields ( <span className="text-red-700">*</span> )
                </>
              }
              formId="references"
              isOpen={addRefIsOpen}
            ...
            />
            <ModalAction isOpen={removeRefIsOpen} setIsOpen={setRemoveRefIsOpen} action={() => handleRemoveTitle(refToRemove)} />
            {references.length === 0 ? (
              <>
                <NoDataVisual />
              </>
