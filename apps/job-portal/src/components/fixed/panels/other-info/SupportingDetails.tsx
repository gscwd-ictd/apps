            ...
            <div className="pb-4">
              ...
              <div className="my-2">
                <FloatingLabelInputRF
                  ...
                  hidden={
                    guiltyCharged.isGuilty.toString() === 'true' ? false : guiltyCharged.isGuilty.toString() === 'false' ? true : false
                  }
      ...
      <Card
        ...
        children={
          <>
            <div>
              <h4>
                Pursuant to: (a) Indigenous People's Act (RA 8371); (b) Magna Carta for Disabled Persons (RA 7277); and (c) Solo Parents
