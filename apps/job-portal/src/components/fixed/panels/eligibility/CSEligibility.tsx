...
import { EligibilityState, Eligibility } from '../../../../types/data/eligibility.type'
...
export const CSEligibility = (): JSX.Element => {
  ...
  const { eligibility, setEligibility } = usePdsStore((state) => ({ eligibility: state.eligibility, setEligibility: state.setEligibility }))
        ...
        children={
          <>
            <Modal
              ...
              subtitle={
                <>
                  CAREER SERVICE/ RA 1080 (BOARD/ BAR) UNDER SPECIAL LAWS/ CES/ CSEE BARANGAY ELIGIBILITY / DRIVER'S LICENSE <br></br>{' '}
              ...
              children={
                <>
                  <div className="mb-5 gap-4 p-5">
                    ...
                    <div className="mt-10 grid-cols-2 gap-8 sm:grid md:grid lg:flex">
                      <div className="col-span-1 mb-10 w-full sm:block">
                        <InputReactForm
                          id="eligexamplace"
                          name="eligexamplace"
            ...
            />
            <ModalAction isOpen={removeEligIsOpen} setIsOpen={setRemoveEligIsOpen} action={() => handleRemoveElig(eligToRemove)} />
                      ...
                      {eligibility.map((elig: Eligibility, eligIdx: number) => {
                        return (
                          ...
                          >
                            ...
                            <TableDimension isText={true} label={elig.rating ? elig.rating : 'N/A'} className="select-none px-1" />
                            <TableDimension
                              isText={true}
