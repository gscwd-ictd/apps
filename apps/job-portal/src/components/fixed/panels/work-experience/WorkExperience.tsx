      ...
      <Card
        ...
        children={
          <>
            <Modal
              ...
              subtitle={
                <>
                  ...
                  Experience sheet. Indicate FULL position titles and COMPLETE NAME of department / agency / office / company. <br></br>{' '}
              ...
              children={
                <>
                  <div className="mb-5 gap-4 p-5">
                    ...
                    <div className="mt-10 grid-cols-3 gap-8 sm:grid md:grid lg:flex">
            ...
            />
            <ModalAction isOpen={removeWorkExpIsOpen} setIsOpen={setRemoveWorkExpIsOpen} action={() => handleRemoveWork(workExpToRemove)} />
                      ...
                      {workExperience.map((work: WorkExperience, workIdx: number) => {
                        return (
                          ...
                          >
                            ...
                            <TableDimension isText={true} label={work.companyName} className="select-none px-1" />
                            <TableDimension
                              isText={true}
                              isPeriod={true}
