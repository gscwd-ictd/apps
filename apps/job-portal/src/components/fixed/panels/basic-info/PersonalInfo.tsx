...
export const PersonalInfoBI = (): JSX.Element => {
  ...
  const onChangeCitizenship = (e: ChangeEvent<HTMLSelectElement>) => {
    ...
    if (e.currentTarget.value === 'Filipino') {
      ...
      setPersonalInfo({ ...personalInfo, country: 'Philippines', citizenship: e.currentTarget.value, citizenshipType: '' })
    ...
    // if citizenship is set to Dual Citizenship
      ...
      setPersonalInfo({ ...personalInfo, country: '', citizenship: e.currentTarget.value, citizenshipType: '' })
      setValue('country', '')
      setValue('citizenshipType', '')
    }
  }
  ...
  return (
    <>
      <Card
        ...
        children={
          <>
            <div className="xs:block mt-7 gap-4 sm:block md:block lg:flex lg:grid-cols-2 ">
                ...
                <FloatingLabelInputRF
                  ...
                  controller={{
                    ...register('nameExtension', {
                      ...
                      onChange: (e) => setPersonalInfo({ ...personalInfo, nameExtension: e.target.value }),
                    }),
                  }}
            ...
            <div className="xs:block gap-4 lg:flex lg:grid-cols-2">
              <div className="col-span-1 mb-7 w-full">
                <FloatingLabelInputRF
                  ...
                  isRequired
                  defaultValue={
                    personalInfo.birthDate ? dayjs(personalInfo.birthDate, 'YYYY-MM-DD+h:mm').format('YYYY-MM-DD').toString() : ''
                  }
                  type="date"
                  controller={{
                    ...register('birthDate', {
            ...
            <div className="xs:block gap-4 lg:flex lg:grid-cols-4">
              <div className="col-span-1 mb-7 w-full">
                <SelectListRFFL
                  id="civilStatus"
                  isRequired
            ...
            <div className="xs:gap-8 xs:grid sm:grid sm:gap-8 md:grid md:gap-4 lg:grid xl:flex xl:grid-cols-2">
              <div className="w-full">
                <RadioGroup
                  ...
                  children={
                    <>
                      <div className="xs:grid grid-cols-2 sm:grid md:grid lg:grid xl:grid">
                        <RadioButtonRF
                          id="filipino"
                          name="citizenship"
                          label="Filipino"
                          ...
                          value="Filipino"
                          controller={{
                            ...register('citizenship', { value: personalInfo.citizenship, onChange: (e) => onChangeCitizenship(e) }),
                          }}
                        />
                        <RadioButtonRF
                          id="dual-citizenship"
          ...
          cursor-text bg-white text-xs font-normal text-gray-400 transition-all peer-placeholder-shown:-inset-y-[0.85rem] peer-placeholder-shown:left-0  peer-placeholder-shown:text-base
            peer-placeholder-shown:text-gray-600 peer-focus:bg-white peer-focus:text-xs peer-focus:text-gray-400"
              ...
              <div className="col-span-1 w-full sm:mt-2 sm:mb-7 sm:grid md:mt-2 md:mb-7 md:grid lg:col-span-1 lg:mt-2 lg:mb-7">
                ...
                <FloatingLabelInputRF
                  ...
                  controller={{
                    ...register('telephoneNumber', {
                      ...
                      onChange: (e) => setPersonalInfo({ ...personalInfo, telephoneNumber: e.target.value }),
                    }),
                  }}
