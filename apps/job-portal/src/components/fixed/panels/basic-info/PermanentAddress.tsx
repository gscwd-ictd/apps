...
export const PermanentAddressBI = (): JSX.Element => {
  ...
  useEffect(() => {
    checkboxAddress
      ? setPermanentAddress({
          ...permanentAddress,
          houseNumber: (permaHouseNoRef.current.value = residentialAddress.houseNumber),
          street: (permaStreetRef.current.value = residentialAddress.street),
          subdivision: (permaSubdRef.current.value = residentialAddress.subdivision),
          provCode: (permaProvCodeRef.current.value = residentialAddress.provCode),
          province: residentialAddress.province,
          cityCode: (permaCityCodeRef.current.value = residentialAddress.cityCode),
          city: residentialAddress.city,
          brgyCode: (permaBrgyCodeRef.current.value = residentialAddress.brgyCode),
