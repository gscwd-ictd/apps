...
export const Graduate = (): JSX.Element => {
  ...
  const onSubmit = handleSubmit((course: EducationInfo, e: any) => {
    ...
    const sortedUpdatedGraduate = [...updatedGraduate].sort((firstItem, secondItem) =>
  ...
  return (
    <>
      <Card
        ...
        remarks={
          <Button btnLabel="Add Graduate Studies" type="button" variant="theme" onClick={openModal} shadow className="sm:w-full lg:w-56" />
        }
