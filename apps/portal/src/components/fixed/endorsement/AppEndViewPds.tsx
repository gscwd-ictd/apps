    ...
    <>
      <div className="flex flex-col justify-center">
        ...
        {pds && pds.permanentAddress ? (
                        ...
                        <CardPreview title="Personal Information" subtitle="">
                          <>
                              ...
                              field={
                                <>
                                  {pds.personalInfo.firstName &&
                                    pds.personalInfo.firstName + ' '}
                                  {pds.personalInfo.middleName === 'N/A'
                                    ? ''
                                    : pds.personalInfo.middleName + ' '}
                                  {pds.personalInfo.lastName &&
                                    pds.personalInfo.lastName + ' '}
                                  {pds.personalInfo.nameExtension === 'N/A'
                                    ? ''
                            ...
                            <LabelFieldPreview
                              ...
                              field={
                                pds.personalInfo.birthDate
                                  ? dayjs(pds.personalInfo.birthDate).format(
                                      'MMMM DD, YYYY'
                                    )
                                  : 'N/A'
                              }
                            ...
                            <LabelFieldPreview
                              label="Height:"
                              field={
                                pds.personalInfo.height
                                  ? pds.personalInfo.height + ' meters'
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                              label="Weight:"
                              field={
                                pds.personalInfo.weight
                                  ? pds.personalInfo.weight + ' kgs'
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                        ...
                        <CardPreview title="Government IDs" subtitle="">
                          <>
                            ...
                            <LabelFieldPreview
                              label="GSIS No:"
                              field={
                                pds.governmentIssuedIds.gsisNumber
                                  ? pds.governmentIssuedIds.gsisNumber
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                              label="Pag-ibig No:"
                              field={
                                pds.governmentIssuedIds.pagibigNumber
                                  ? pds.governmentIssuedIds.pagibigNumber
                                  : 'N/A'
                              }
                            />
                            ...
                            <LabelFieldPreview
                              label="SSS No:"
                              field={
                                pds.governmentIssuedIds.sssNumber
                                  ? pds.governmentIssuedIds.sssNumber
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                              label="TIN No:"
                              field={
                                pds.governmentIssuedIds.tinNumber
                                  ? pds.governmentIssuedIds.tinNumber
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                              label="Agency No:"
                              field={
                                pds.governmentIssuedIds.agencyNumber
                                  ? pds.governmentIssuedIds.agencyNumber
                                  : 'N/A'
                              }
                            />
                        ...
                        <CardPreview title="Residential Address" subtitle="">
                          <>
                            <LabelFieldPreview
                              ...
                              field={
                                pds.residentialAddress.houseNumber
                                  ? pds.residentialAddress.houseNumber
                                  : 'N/A'
                              }
                            />
                            ...
                            <LabelFieldPreview
                              label="Subdivision:"
                              field={
                                pds.residentialAddress.subdivision
                                  ? pds.residentialAddress.subdivision
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                              label="Barangay:"
                              field={
                                pds.residentialAddress.barangay
                                  ? pds.residentialAddress.barangay
                                  : 'N/A'
                              }
                            />
                            ...
                            <LabelFieldPreview
                              label="Province:"
                              field={
                                pds.residentialAddress.province
                                  ? pds.residentialAddress.province
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                              label="Zipcode"
                              field={
                                pds.residentialAddress.zipCode
                                  ? pds.residentialAddress.zipCode
                                  : 'N/A'
                              }
                            />
                        ...
                        <CardPreview title="Permanent Address" subtitle="">
                          <>
                            <LabelFieldPreview
                              label="House/Block/Lot No:"
                              field={
                                pds.permanentAddress.houseNumber
                                  ? pds.permanentAddress.houseNumber
                                  : 'N/A'
                              }
                            />
                            ...
                            <LabelFieldPreview
                              label="Subdivision:"
                              field={
                                pds.permanentAddress.subdivision
                                  ? pds.permanentAddress.subdivision
                                  : 'N/A'
                              }
                            />
                        ...
                        <CardPreview title="Father" subtitle="">
                          <>
                            ...
                            <LabelFieldPreview
                              label="Name Extension:"
                              field={
                                pds.parents.fatherNameExtension
                                  ? pds.parents.fatherNameExtension
                                  : 'N/A'
                              }
                            />
                  ...
                  >
                    <>
                      <div className="px-2">
                        ...
                        >
                          <>
                            {pds.elementary.schoolName === '' ||
                            pds.elementary.schoolName === null ? (
                              <div className="rounded shadow-sm shadow-slate-200">
                                <NotApplicableVisual />
                              </div>
                            ) : (
                        ...
                        >
                          <>
                            {pds.secondary.schoolName === '' ||
                            pds.secondary.schoolName === null ? (
                              <div className="rounded shadow-sm shadow-slate-200">
                                <NotApplicableVisual />
                              </div>
                            ) : (
                              <>
                                <div className="col-span-1 mb-[0.2%] justify-between border rounded bg-white py-10 px-[5%] text-left align-middle shadow-md hover:bg-indigo-100">
                                  <LabelFieldPreview
                                    label="School:"
                                    field={pds.secondary.schoolName}
                                  />
                                  <LabelFieldPreview
                                    label="Basic Education:"
                                    field={
                                      pds.secondary.degree
                                        ? pds.secondary.degree
                                        : 'N/A'
                                    }
                                  />
                    ...
                    <>
                      <div className="px-2">
                        {pds.eligibility.length === 0 ? (
                          ...
                          <>
                            {pds.eligibility.map(
                              (elig: Eligibility, eligIdx: number) => {
                                const {
                                  name,
                                  rating,
                                  examDateFrom,
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <LabelFieldPreview
                                      label="Validity:"
                                      field={
                                        validity ? validity.toString() : 'N/A'
                                      }
                                    />
                                  </div>
                                );
                                ...
                                return (
                                  ...
                                  >
                                    <LabelFieldPreview
                                      ...
                                      field={
                                        positionTitle ? positionTitle : 'N/A'
                                      }
                                    />
                                    <LabelFieldPreview
                                      label="Company Name:"
                                    ...
                                    <LabelFieldPreview
                                      ...
                                      field={
                                        from
                                          ? dayjs(from).format('MMMM DD, YYYY')
                                          : 'N/A'
                                      }
                                    />
                                    <LabelFieldPreview
                                    ...
                                    <LabelFieldPreview
                                      ...
                                      field={
                                        monthlySalary ? monthlySalary : 'N/A'
                                      }
                                    />
                                    <LabelFieldPreview
                                      label="Government Service:"
                                      field={
                                        isGovernmentService.toString() ===
                                        'true'
                                          ? 'Yes'
                                          : isGovernmentService.toString() ===
                                            'false'
                    ...
                    <>
                      <div className="px-2">
                        {pds.voluntaryWork.length === 0 ? (
                          ...
                          <>
                            {pds.voluntaryWork.map(
                              (work: VoluntaryWork, workIdx) => {
                                const {
                                  position,
                                  organizationName,
                                  from,
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <LabelFieldPreview
                                      ...
                                      field={
                                        numberOfHours ? numberOfHours : 'N/A'
                                      }
                                    />
                                  </div>
                                );
                          ...
                          <>
                            {pds.references.map(
                              (reference: Reference, refIdx: number) => {
                                const { name, address, telephoneNumber } =
                                  reference;
                                return (
                                  <div
                                    key={refIdx}
                        ...
                        <CardPreview title="" subtitle="">
                          <>
                            <LabelFieldPreview
                              label="Government ID: "
                              field={
                                pds.governmentIssuedId.issuedId
                                  ? pds.governmentIssuedId.issuedId
                                  : 'N/A'
                              }
                            />
                            <LabelFieldPreview
                              label="ID number: "
                              field={
                                pds.governmentIssuedId.idNumber
                                  ? pds.governmentIssuedId.idNumber
                                  : 'N/A'
                              }
                            />
                            ...
                            <LabelFieldPreview
                              label="Issued Place"
                              field={
                                pds.governmentIssuedId.issuePlace
                                  ? pds.governmentIssuedId.issuePlace
                                  : 'N/A'
                              }
                            />
          ...
          >
            <label className="text-lg uppercase">Not found</label>
          </div>
        )}
      </div>
    </>
