    ...
    return (<>
        {publications && publications.length > 0 ? (
                    ...
                    return (
                        ...
                        >
                            <div className=" w-full py-2 px-1 ">
                                ...
                                <p className="text-md text-gray-500">Fulfilled on {dayjs(item.postingDate).format('MMMM d, YYYY')}</p>
            ...
            <div className="flex justify-center pt-20">
                <h1 className="text-4xl text-gray-300">No {tab === 1 ? 'pending publication for selection' : tab === 2 ? 'fulfilled publication' : ''} at the moment</h1>
            </div>
        )}
    </>)
