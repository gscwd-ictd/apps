  ...
  return (
    <>
      <div className="w-full">
        <div className="flex h-auto p-4 mt-5 mb-2 rounded">
          <section className="w-[50%]">
            <div className="flex w-full align-text-top">
              <p className="flex justify-start font-normal text-xs text-gray-700 w-[25%]">
                Date of Panel Interview:
              </p>
              <p className="flex justify-start font-normal text-sm text-gray-800 w-[75%] pl-10">
          ...
          <section className="w-[50%] pl-28">
            ...
            <div className="flex w-full pl-10 align-text-top">
              <p className="flex justify-start font-normal text-xs text-gray-700 w-[75%]">
                Number of Interviewed Applicants:
              </p>
              <p className="flex justify-start font-normal text-sm text-gray-800 w-[25%]">
