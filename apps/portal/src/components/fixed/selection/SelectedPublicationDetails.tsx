  ...
  return (
    <>
      <div className="w-full">
        <div className="flex flex-col lg:flex-row h-auto p-4 mt-5 mb-2 rounded">
          <section className="w-full lg:w-[50%]">
            <div className="flex w-full align-text-top">
              <p className="flex justify-start font-normal text-xs text-gray-700 w-[50%] lg:w-[50%]">
            ...
            <div className="flex w-full align-text-top">
              <p className="flex justify-start font-normal text-xs text-gray-700 w-[75%] lg:w-[50%]">
          ...
          <section className="w-full lg:w-[50%] lg:pl-28">
            ...
            <div className="flex w-full lg:pl-10 align-text-top">
              <p className="flex justify-start font-normal text-xs text-gray-700 w-[75%] lg:w-[75%]">
