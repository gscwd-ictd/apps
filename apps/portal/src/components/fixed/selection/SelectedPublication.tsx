        ...
        <div className="bg-indigo-800 h-auto rounded p-4 mx-2 flex flex-col lg:flex-row">
          <section className="w-full lg:w-[50%] ">
            <div className="flex w-full align-text-top pt-[0.2rem]">
              <p className="flex justify-start text-xs font-light text-gray-100 w-[25%]">
                Position title:
              </p>
            ...
            <div className="flex w-full align-text-top pt-[0.2rem]">
              <p className="flex justify-start font-light text-xs text-gray-100 w-[25%]">
                Item No:
              </p>
              <p className="flex justify-start font-normal text-sm text-white w-[75%] pl-10">
          ...
          <section className="w-full lg:w-[50%] lg:pl-28">
            <div className="flex w-full align-text-top pt-[0.2rem]">
              <p className="flex justify-start font-light text-xs text-gray-100 w-[25%] lg:w-[75%] lg:pl-10">
                PRF No:
              </p>
