export const Announcements = [
  {
    title: 'Honesty at All Cost',
    desc: 'The PRAISE Committee commends BONIPHER BALISACAN of the GSPMMD for returning a 500-peso bill he found at the Female comfort room of GSCWD Training Hall.',
    link: 'https://www.facebook.com/photo/?fbid=320792983635639&set=a.109004071481199',
    src: '/01.jpg',
  },
  {
    title: 'Oathtaking of Newly Promoted Personnel',
    desc: 'Oathtaking of Newly-Promoted Personnel was conducted Monday during the morning flag ceremony (July 31). Organized by the Human Resouce Department, twenty-two (22) employees took their oath before AGM for Finance Francisco R. Alolod.',
