...
const typeOfLeave: Array<SelectOption> = [
  { label: LeaveName.VACATION, value: '585e4746-e09b-4720-80ba-3f059daa2b5e' },
  { label: LeaveName.FORCED, value: '59d3f978-431d-4fbb-8949-19cfd7c5a218' },
  { label: LeaveName.SICK, value: 'acdf4218-313c-4abc-a884-13f302b322f5' },
  { label: LeaveName.MATERNITY, value: 'Maternity Leave_id_235345345' },
  { label: 'Paternity Leave', value: 'Paternity Leave_id_235345345' },
  {
    label: LeaveName.SPECIAL_PRIVILEGE,
    value: 'Special Privilege Leave_id_235345345',
  },
  { label: 'Solo Parent Leave', value: 'Solo Parent Leave_id_235345345' },
  { label: LeaveName.STUDY, value: 'Study Leave_id_235345345' },
  ...
  {
    label: LeaveName.SPECIAL_LEAVE_BENEFITS_FOR_WOMEN,
  ...
  { label: LeaveName.OTHERS, value: 'Others_id_235345345' },
];
...
export const LeaveApplicationModal = ({
  ...
  const onSubmit: SubmitHandler<LeaveApplicationForm> = (
    ...
    let dataToSend;
    if (data.typeOfLeaveDetails.leaveName === LeaveName.VACATION) {
      ...
      data.typeOfLeaveDetails.leaveName ===
                      ...
                      <textarea
                        ...
                        placeholder={`${
                          ...
                          watch('typeOfLeaveDetails.leaveName') ===
                            ...
                            ? 'Specify Illness'
                            : watch('typeOfLeaveDetails.leaveName') ===
                                LeaveName.STUDY && selectedStudy === 'other'
