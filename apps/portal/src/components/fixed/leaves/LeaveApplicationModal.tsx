...
const typeOfLeave: Array<SelectOption> = [
  ...
  { label: 'Forced Leave', value: 'Forced Leave' },
...
export const LeaveApplicationModal = ({
  ...
  // React hook form
  const { reset, control, register, handleSubmit, watch, setValue } =
                      ...
                      </option>
                      {
                        ...
                        typeOfLeave
                          ? // swrLeaveTypes.map((item: LeaveType, idx: number) => (
                            ...
                            typeOfLeave.map((item: Item, idx: number) => (
                ...
                <div>
                  {watch('typeOfLeave') ? (
                    <div className="flex flex-col gap-1 w-full bg-slate-100 text-sm p-2 mt-1">
                      <span className="font-bold">{watch('typeOfLeave')}</span>
                      <span>
