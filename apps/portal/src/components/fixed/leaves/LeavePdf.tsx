          ...
          <Document title="Leave">
            ...
            <Page size={[612.0, 792.0]}>
              <View style={styles.page}>
                ...
                <Text
                  style={{ position: 'absolute', fontSize: 6, marginTop: 10 }}
                >
                  Revised 2020
                </Text>
                ...
                >
                  <View style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    >
                      ...
                      <View style={styles.leaveLabelContainer2}>
                        ...
                        <Text style={{ fontSize: 6, paddingLeft: 20 }}>
                          _______________________________________
                        </Text>
                        <Text
                          style={{
                      ...
                      <Text style={styles.inCase}>
                        In case of Special Leave Benefit for Women:
                      </Text>
                      <View style={styles.leaveLabelContainer2}>
                        <Text style={styles.leaveLabel}>
                          (Specify Illness):
                  ...
                  <View style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    >
                      ...
                      >
                        asdas dsadas dasd sa dsa dasd sad asda sdsadsda dsa
                        dadsa da dsadasd dasdas dasdas dasdas dsa
                      </Text>
                ...
                >
                  <View style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    >
                      ...
                      <View style={{ marginLeft: 30 }}>
                        ...
                        >
                          asdas dsadas dasd sa dsa dasd sad asda sdsadsda dsa
                          dadsa da dsadasd sdsdasdas dasdas dasdas sadsadd
                          sadasdsa dsad asds asdsad dsa
                        </Text>
                        <Text style={{ padding: 5 }}>
                  ...
                  >
                    <Text style={{ paddingTop: 6, paddingBottom: 4 }}>
            ...
            <Page size={[612.0, 792.0]}>
              <View style={styles.page}>
                ...
                >
                  ...
                  >
                    <Text>
                      Application for any type of leave shall be made on this
                      Form and to be accomplished at least in duplicate with
                      documentary requirements, as follows:
                    </Text>
                    <Text
                      style={{ fontFamily: 'Helvetica-Bold', paddingTop: 8 }}
                    >
                      1. Vacation leave*
                    </Text>
                    <Text>
                      It shall be filed five (5) days in advance, whenever
                      possible, of the effective date of such leave. Vacation
                      leave within in the Philippines or abroad shall be
                      indicated in the form for purpose of securing travel
                    ...
                    <Text>
                      Annual five-day vacation leave shall be forfeited if not
                      taken during the year. In case the scheduled leave has
                      been cancelled in the exigency of the service by the head
                      of agency, it shall no longer be deducted from the
                      accumulated vacation leave. Availment of one (1) day or
                      more Vacation Leave (VL) shall be considered for complying
                      the mandatory/forced leave subject to the conditions under
                      Section 25, Rule XVI of the Omnibus Rules Implementing
                      E.O. No. 292.
                    </Text>
                    ...
                    <Text>
                      * It shall be filed immediately upon employee's return
                      from such leave.
                    </Text>
                    <Text>
                      * If filed in advance or exceeding five (5) days,
                      application shall be accompanied by a medical certificate.
                      In case medical consultation was not availed of, an
                      affidavit should be executed by an applicant.
                    </Text>
                    ...
                    <Text>
                      * Proof of pregnancy e.g. ultrasound, doctor's certificate
                      on the expected date of delivery.
                    </Text>
                    <Text>
                      * Accomplished Noticed of Allocation of Maternity Leave
                      Credits (CS Form No. 6a), if needed.
                    </Text>
                    <Text>
                      * Seconded female employees shall enjoy maternity leave
                      with full pay in the recipient agency.
                    </Text>
                    ...
                    <Text>
                      It shall be filed/approved for at least one (1) week prior
                      to availment, except on emergency cases. Special privilege
                      leave within the Philippines or abroad shall be indicated
                      in the form for purposes of securing travel authority and
                    ...
                    <Text>
                      It shall be filed in advance or whenever possible five (5)
                      days before going on such leave with updated Solo Parent
                      Identification Card.
                    </Text>
                    ...
                    <Text>
                      * Contract between the agency head or authorized
                      representative and employee concerned.
                    </Text>
                    ...
                    <Text>
                      * It shall be filed in advance or immediately upon the
                      woman employee's return from such leave.
                    </Text>
                    <Text>
                      * It shall be accompanied by any of the following
                    ...
                    <Text>
                      b. Temporary/Permanent Protection Order (TPO/PPO) obtained
                      from the court;
                    </Text>
                    <Text>
                      c. If the protection order is not yet issued by the
                      barangay or the court, a certification issued by the
                      Punong Barangay/Kagawad or Prosecutor or the Clerk of
                      Court that the application for the BPO, TPO or PPO has
                      been filed with the said office shall be sufficient to
                  ...
                  >
                    <Text>
                      d. In the absence of the BPO/TPO/PPO or the certification,
                      a police report specifying the details of the occurrence
                      of violence on the victim and a medical certificate may be
                      considered, at the discretion of the immediate supervisor
                    ...
                    <Text>
                      * Application shall be made within one (1) week from the
                      time of the accident except when a longer period is
                      warranted.
                    </Text>
                    <Text>
                      * Letter request supported by relevant reports such as the
                      police report, if any,
                    </Text>
                    <Text>
                      * Medical certificate on the nature of the injuries, the
                      course of treatment involved, and the need to undergo
                      rest, recuperation, and rehabilitation, as the case may
                      be.
                    </Text>
                    <Text>
                      * Written concurrence of a government physician should be
                      obtained relative to the recommendation for rehabilitation
                      if the attending physician is a private practicioner,
                    ...
                    <Text>
                      * The application may be filed in advance, that is, at
                      least five (5) days prior to the scheduled date of the
                      gynercological surgery that will be undergone by the
                      employee. In case of emergency, the application for
                      special leave shall be filed immediately upon employee's
                      return but during confinement the agency shall be notified
                      of said surgery.{' '}
                    </Text>
                    <Text>
                      * The application shall be accompanied by a medical
                      certificate filled out by the proper medical authorities,
                      e.g. the attending surgeon accompanied by a clinical
                      summary reflecting the gynecological disorder which shall
                      be addressed or was addressed by the said surgery; the
                      histopathological report; the operative technique used for
                      the surgery; the duration of the surgery including the
                      perioperative period (period of confinement around
                      surgery); as well as the employees estimated period of
                    ...
                    <Text>
                      * The special emergency leave can be applied for a maximum
                      of five (5) straight working days or staggered basis
                      within thirty (30) days from the actual occurence of the
                      natural calamity/disaster. Said privilege shall be enjoyed
                      once a year, not in every instance of calamity or
                      disaster.
                    </Text>
                    <Text>
                      * The head of office shall take full responsibility for
                      the grant of special emergency leave and verification of
                      the employee's eligibility to be granted thereof. Said
                      verification shall include: validation of place of
                      ...
                      by the proper government agency; and such other proofs as
                      may be necessary.
                    </Text>
                    ...
                    <Text>
                      Application for monetization of fifty percent (50%) or
                      more of the accumulated leave credits shall be accompanied
                      by letter request to the head of the agency stating the
                    ...
                    <Text>
                      Proof of employee's resignation or retirement or
                    ...
                    <Text>
                      * Application for adoption leave shall be filed with an
                      authenticated copy of the Pre-Adoptive Placement Authority
                ...
                <Text style={{ fontSize: 9, paddingTop: 20 }}>
                  * For leave of absence for thirty (30) calendar days or more
                  ...
                  accountabilities (persuant to CSC Memorandum Circular No. 2,
                  s. 1985).
                </Text>
              </View>
            </Page>
