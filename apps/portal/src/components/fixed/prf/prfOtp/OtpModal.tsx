...
// export const OtpPrfModal: FunctionComponent<OtpProps> = ({
//   mobile,
//   isModalOpen,
//   employeeId,
//   remarks,
...
//     e.preventDefault();
//     setCountingDown(false);
//     localStorage.removeItem(`prfOtpEndTime_${router.query.prfid}`); //delete otp expiration local storage
//     localStorage.removeItem(`prfOtpToken_${router.query.prfid}`); //delete otp expiration local storage
//     setIsSendOtpLoading(false); //close loading circle animation and countdown
