        ...
        {forApprovalPrfs.length === 0 ? (
          <>
            <div className="flex h-full justify-center pt-32 w-full px-[18%]">
              <p className="text-4xl text-center font-bold text-gray-300">No requests awaiting your approval</p>
            </div>
          </>
        ) : (
          <>
            <header className="px-5 mb-5">
              ...
              <p className="text-sm text-gray-500">Click on each request item to view more details.</p>
            </header>
