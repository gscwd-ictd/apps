...
export const DisapprovedPrfList: FunctionComponent<DisapprovedPrfListProps> = () => {
      ...
      {disapprovedPrfs.length === 0 ? (
        <>
          <div className="flex h-full justify-center pt-32 w-full px-[18%]">
            <p className="text-4xl text-center font-bold text-gray-300">No disapproved requests at the moment</p>
          </div>
        </>
      ) : (
        <>
          <header className="px-5 mb-5">
            <h3 className="font-medium text-gray-600 pt-3">Disapproved Requests</h3>
