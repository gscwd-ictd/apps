...
export const OvertimeSummaryReportPdfEdit = ({
  selectedMonth,
  selectedPeriod,
            ...
            <View style={styles.table}>
              <View fixed style={[styles.tableRow, { borderWidth: 0 }]}>
                ...
                <View style={[styles.tableCol, { borderStyle: 'solid', borderBottomWidth: 1, borderTopWidth: 1 }]}>
                  <Text style={{ margin: 'auto', textAlign: 'center', fontSize: 8, width: 100 }}>NAME</Text>
                </View>
                ...
                >
                  <Text style={styles.tableCell}>TOTAL OVERTIME AMOUNT OLD (NO MULTIPLIERS)</Text>
                </View>
                ...
                overtimeSummaryReport?.summary?.map((overtime: OvertimeSummaryEmployee, idx: number) => (
                  <View style={[styles.tableRow, { borderTop: '0px solid #000' }]} key={idx} wrap={false}>
                    ...
                    <View style={styles.tableCol}>
                      <Text style={{ margin: 'auto', textAlign: 'left', fontSize: 8, width: 100 }}>
                        {overtime?.employeeFullName}
                      </Text>
                    </View>

                    <View style={[styles.tableCol, { width: 45 }]}>
                      <Text style={styles.tableCell}>{overtime?.monthlyRate}</Text>
                      {/* <Text style={styles.tableCell}>{overtime?.monthlyRate?.toLocaleString()}</Text> */}
                    </View>

                    <View style={[styles.tableCol, { width: 35 }]}>
                      <Text style={styles.tableCell}>{overtime?.hourlyRate}</Text>
                    ...
                    <View style={[styles.tableCol, { width: 40 }]}>
                      <Text style={styles.tableCell}>{overtime?.regularOTAmount}</Text>
                    ...
                    <View style={[styles.tableCol, { width: 40 }]}>
                      <Text style={styles.tableCell}>{overtime?.offOTAmount}</Text>
                    ...
                    <View style={[styles.tableCol, { width: 50 }]}>
                      <Text style={styles.tableCell}>{overtime?.substituteAmount}</Text>
                    ...
                    <View style={[styles.tableCol, { width: 50 }]}>
                      ...
                      {/* <Text style={styles.tableCell}>
                        {selectedEmployeeType !== 'job order'
                          ? ''
                          : overtime?.differenceTotalOvertimeOld.toLocaleString()}
                      </Text> */}
                    </View>
                  </View>
                ))}
              ...
              <View style={[styles.tableRow, { borderTop: '0px solid #000' }]} wrap={false}>
                ...
                <View style={[styles.tableCol, { borderLeftWidth: 1 }]}>
                  <Text style={{ margin: 'auto', textAlign: 'left', fontSize: 8, width: 119, paddingLeft: 5 }}>
                    TOTAL
                  </Text>
                </View>
                ...
                <View style={[styles.tableCol, { width: 40 }]}>
                  <Text style={styles.tableCell}>{overtimeSummaryReport?.overallTotalRegularOTAmount}</Text>
                  {/* <Text style={styles.tableCell}>
                ...
                <View style={[styles.tableCol, { width: 40 }]}>
                  <Text style={styles.tableCell}>{overtimeSummaryReport?.overallTotalOffOTAmount}</Text>
                  {/* <Text style={styles.tableCell}>
                ...
                <View style={[styles.tableCol, { width: 50 }]}>
                  <Text style={styles.tableCell}>{overtimeSummaryReport?.overallSubstituteDutyOTAmount}</Text>
                  {/* <Text style={styles.tableCell}>
                ...
                <View style={[styles.tableCol, { width: 55 }]}>
                  <Text style={styles.tableCell}>
                    {selectedEmployeeType !== 'job order' ? '' : overtimeSummaryReport?.overallTotalOTAmountOld}
                  </Text>
                  {/* <Text style={styles.tableCell}>
                    {selectedEmployeeType !== 'job order'
                      ? ''
                      : overtimeSummaryReport?.overallTotalOTAmountOld?.toLocaleString()}
                  </Text> */}
                </View>
                <View style={[styles.tableCol, { width: 50 }]}>
                  <Text style={styles.tableCell}>
                    {selectedEmployeeType !== 'job order'
                      ? ''
                      : overtimeSummaryReport?.differenceOverallTotalOTAmountAndOld}
                  </Text>
                  {/* <Text style={styles.tableCell}>
                    {selectedEmployeeType !== 'job order'
                      ? ''
                      : overtimeSummaryReport?.differenceOverallTotalOTAmountAndOld?.toLocaleString()}
                  </Text> */}
                </View>
              </View>
            </View>
...
export default OvertimeSummaryReportPdfEdit;
