...
import { OfficeRelation, GuiltyCharged, Convicted, SeparatedService, CandidateResigned, Immigrant, IndigenousPwdSoloParent, SupportingDetails, GovernmentIssuedId, Reference } from '../../src/types/data/supporting-info.type'
