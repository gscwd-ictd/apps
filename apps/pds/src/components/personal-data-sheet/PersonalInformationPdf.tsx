...
export const PersonalInformationPdf = ({
  ...
  residentialAddress,
  governmentIssuedIds,
}: PersonalInformationPdfProps): JSX.Element => {
  return (
    <View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.w42]}>
          ...
          <View
            style={[styles.borderRight, styles.inputValue, styles.w59_3, { flexDirection: 'row', padding: '3 8 0 8' }]}
          >
            <View style={{ flexDirection: 'row' }}>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            ...
            <Text style={[styles.w50]}>
              {residentialAddress.province.toLowerCase() === 'south cotabato' &&
              residentialAddress.city.toLowerCase() === 'general santos city (dadiangas)'
                ? 'N/A'
      ...
      <View style={styles.lineContainer}>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          <View
            style={[styles.borderRight, styles.inputKey, styles.w26_5, { padding: '4 8 0 8', textAlign: 'center' }]}
          >
            <Text>ZIP CODE</Text>
          </View>
      ...
      <View style={styles.lineContainer}>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            ...
            <Text style={[styles.w50]}>
              {permanentAddress.province.toLowerCase() === 'south cotabato' &&
              permanentAddress.city.toLowerCase() === 'general santos city (dadiangas)'
                ? 'N/A'
      ...
      <View style={styles.lineContainer}>
        ...
        <View style={[styles.lineContainer, styles.borderTop, styles.w58]}>
          ...
          <View style={[styles.inputValue, styles.w73_5, { padding: '4 8' }]}>
            <Text style={[styles.w100, { textTransform: 'lowercase' }]}>{personalInfo.email || 'N/A'}</Text>
          </View>
        </View>
      </View>
    </View>
