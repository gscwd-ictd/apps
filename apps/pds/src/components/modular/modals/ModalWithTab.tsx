...
import React, { Dispatch, FormEvent, Fragment, MouseEventHandler, MutableRefObject, ReactFragment, SetStateAction, useRef } from 'react';
    ...
    <>
      <Transition.Root appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 z-50 overflow-y-auto" static={isStatic} onClose={isStatic ? () => null : () => setIsOpen(false)}>
          <form onSubmit={onAction} id={formId} className="form min-h-screen px-4 text-center">
            <Transition.Child
              as={Fragment}
