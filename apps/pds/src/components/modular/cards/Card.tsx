...
export const Card = ({
  ...
  return (
    <>
      <div className={` mt-3 rounded-xl border bg-${bgColor} pt-2 pb-10 shadow-md ${className} `}>
        <header>
          <div className="xs:grid grid-cols-2 justify-between sm:grid md:flex lg:flex">
            <div className="col-span-1">
              ...
              <span className={`${subtitleClassName} select-none hover:text-indigo-800`}>{subtitle}</span>
            </div>

            <div className=" lg:text-md md:text-md xs:text-xs col-span-1 pt-2 italic sm:text-xs ">{remarks}</div>
          </div>
        </header>
