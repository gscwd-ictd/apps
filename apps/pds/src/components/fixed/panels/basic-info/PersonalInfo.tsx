...
export const PersonalInfoBI = (): JSX.Element => {
  ...
  return (
    <>
      <Card title={'Personal Information'} subtitle={'This contains your personal information. Write N/A if not applicable'}>
        <>
          ...
          <div className="gap-4 xs:block lg:flex lg:grid-cols-2">
            ...
            <div className="w-full col-span-1 mb-7">
              <SelectListRFFL
                ...
                isRequired
                controller={{
                  ...register('sex', { value: personalInfo.sex, onChange: (e) => setPersonalInfo({ ...personalInfo, sex: e.target.value }) }),
                }}
              ...
              <FloatingLabelInputRF
                ...
                controller={{
                  ...register('height', {
                    ...
                    onChange: (e) => setPersonalInfo({ ...personalInfo, height: parseFloat(e.target.value) }),
                  }),
                }}
              ...
              <FloatingLabelInputRF
                ...
                controller={{
                  ...register('weight', {
                    ...
                    onChange: (e) => setPersonalInfo({ ...personalInfo, weight: parseFloat(e.target.value) }),
                  }),
                }}
              ...
              {personalInfo.citizenship === 'Dual Citizenship' ? (
                <>
                  <SelectListRFFL
                    ...
                    controller={{
                      ...register('citizenshipType', { value: personalInfo.citizenshipType, onChange: (e) => onChangeCitizenshipType(e) }),
                    }}
