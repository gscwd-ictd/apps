                ...
                <div className="px-5">
                      ...
                      <LabelFieldPreview
                        ...
                        field={
                          <>
                            ...
                            {!personalInfo.lastName && !personalInfo.firstName && !personalInfo.middleName && !personalInfo.nameExtension && 'N/A'}
                          </>
                        }
                      />
                      <LabelFieldPreview label="Birthdate:" field={personalInfo.birthDate ? personalInfo.birthDate : 'N/A'} />
                      <LabelFieldPreview label="Sex:" field={personalInfo.sex ? personalInfo.sex : 'N/A'} />
                      <LabelFieldPreview label="Place of Birth:" field={personalInfo.birthPlace ? personalInfo.birthPlace : 'N/A'} />
                      <LabelFieldPreview label="Civil Status:" field={personalInfo.civilStatus ? personalInfo.civilStatus : 'N/A'} />
                      <LabelFieldPreview label="Height:" field={personalInfo.height ? personalInfo.height + ' meters' : 'N/A'} />
                      <LabelFieldPreview label="Weight:" field={personalInfo.weight ? personalInfo.weight + ' kgs' : 'N/A'} />
                      <LabelFieldPreview label="Blood Type:" field={personalInfo.bloodType ? personalInfo.bloodType : 'N/A'} />
                      <LabelFieldPreview label="Citizenship:" field={personalInfo.citizenship ? personalInfo.citizenship : 'N/A'} />
                      <LabelFieldPreview
                        label="Dual Citizenship Type:"
                        field={personalInfo.citizenshipType && personalInfo.citizenship === 'Dual Citizenship' ? personalInfo.citizenshipType : 'N/A'}
                      />
                      <LabelFieldPreview label="Country:" field={personalInfo.country ? personalInfo.country : 'N/A'} />
                      <LabelFieldPreview label="Telephone No:" field={personalInfo.telephoneNumber ? personalInfo.telephoneNumber : 'N/A'} />
                      <LabelFieldPreview label="Mobile No:" field={personalInfo.mobileNumber ? personalInfo.mobileNumber : 'N/A'} />
                      <LabelFieldPreview label="Email Address:" field={personalInfo.email ? personalInfo.email : 'N/A'} />
                    </>
                  </CardPreview>
                  <CardPreview title="Government IDs" subtitle="">
                    <>
                      {/* GOVERNMENT IDS */}
                      <LabelFieldPreview label="GSIS No:" field={governmentIssuedIds.gsisNumber ? governmentIssuedIds.gsisNumber : 'N/A'} />
                      <LabelFieldPreview
                        label="Pagi-ibig No:"
                      ...
                      />
                      <LabelFieldPreview label="SSS No:" field={governmentIssuedIds.sssNumber ? governmentIssuedIds.sssNumber : 'N/A'} />
                      <LabelFieldPreview label="TIN No:" field={governmentIssuedIds.tinNumber ? governmentIssuedIds.tinNumber : 'N/A'} />
                      <LabelFieldPreview label="Agency No:" field={governmentIssuedIds.agencyNumber ? governmentIssuedIds.agencyNumber : 'N/A'} />
                      {/* Contact */}
                    </>
                  </CardPreview>
                  ...
                  <CardPreview title="Residential Address" subtitle="">
                    <>
                      ...
                      />
                      <LabelFieldPreview label="Street:" field={residentialAddress.street ? residentialAddress.street : 'N/A'} />
                      <LabelFieldPreview label="Subdivision:" field={residentialAddress.subdivision ? residentialAddress.subdivision : 'N/A'} />
                      <LabelFieldPreview label="Barangay:" field={residentialAddress.barangay ? residentialAddress.barangay : 'N/A'} />
                      <LabelFieldPreview label="City:" field={residentialAddress.city ? residentialAddress.city : 'N/A'} />
                      <LabelFieldPreview label="Province:" field={residentialAddress.province ? residentialAddress.province : 'N/A'} />
                      <LabelFieldPreview label="Zipcode" field={residentialAddress.zipCode ? residentialAddress.zipCode : 'N/A'} />
                    </>
                  </CardPreview>

                  <CardPreview title="Permanent Address" subtitle="">
                    <>
                      <LabelFieldPreview label="House/Block/Lot No:" field={permanentAddress.houseNumber ? permanentAddress.houseNumber : 'N/A'} />
                      <LabelFieldPreview label="Street:" field={permanentAddress.street ? permanentAddress.street : 'N/A'} />
                      <LabelFieldPreview label="Subdivision:" field={permanentAddress.subdivision ? permanentAddress.subdivision : 'N/A'} />
                      <LabelFieldPreview label="Barangay:" field={permanentAddress.barangay ? permanentAddress.barangay : 'N/A'} />
                      <LabelFieldPreview label="City:" field={permanentAddress.city ? permanentAddress.city : 'N/A'} />
                      <LabelFieldPreview label="Province:" field={permanentAddress.province ? permanentAddress.province : 'N/A'} />
                      <LabelFieldPreview label="Zipcode" field={permanentAddress.zipCode ? permanentAddress.zipCode : 'N/A'} />
                    </>
                  </CardPreview>
                </div>
              </>
                ...
                <div className="px-5">
                  <CardPreview title="Spouse" subtitle="">
                    <>
                      ...
                      <LabelFieldPreview label="Name Extension:" field={spouse.nameExtension ? spouse.nameExtension : 'N/A'} />
                      <LabelFieldPreview label="Employer/Business Name:" field={spouse.employer ? spouse.employer : 'N/A'} />
                      <LabelFieldPreview label="Business Address:" field={spouse.businessAddress ? spouse.businessAddress : 'N/A'} />
                      <LabelFieldPreview label="Telephone No:" field={spouse.telephoneNumber ? spouse.telephoneNumber : 'N/A'} />
                  ...
                  <CardPreview title="Father" subtitle="">
                    <>
                      <LabelFieldPreview label="Last Name:" field={parents.fatherLastName ? parents.fatherLastName : 'N/A'} />
                      <LabelFieldPreview label="First Name:" field={parents.fatherFirstName ? parents.fatherFirstName : 'N/A'} />
                      <LabelFieldPreview label="Middle Name:" field={parents.fatherMiddleName ? parents.fatherMiddleName : 'N/A'} />
                      <LabelFieldPreview label="Name Extension:" field={parents.fatherNameExtension ? parents.fatherNameExtension : 'N/A'} />
                    </>
                  </CardPreview>
                  <CardPreview title="Mother" subtitle="">
                    <>
                      <LabelFieldPreview label="Last Name:" field={parents.motherLastName ? parents.motherLastName : 'N/A'} />
                      <LabelFieldPreview label="First Name:" field={parents.motherFirstName ? parents.motherFirstName : 'N/A'} />
                      <LabelFieldPreview label="Middle Name:" field={parents.motherMiddleName ? parents.motherMiddleName : 'N/A'} />
                      {/* <LabelFieldPreview label="Maiden Name:" field={parents.motherMaidenName ? parents.motherMaidenName : 'N/A'} /> */}
                    </>
                  </CardPreview>

                  <CardContainer title="Children Information" titleSize="xl" isArray cols={children.length} titleClassName="font-medium">
                    <>
                      {children.length === 0 ? (
            ...
            <CardContainer title="Educational Background" className="py-5" cols={1}>
              <>
                <div className="px-5">
                      ...
                      {elementary.schoolName === '' || elementary.schoolName === null ? (
                        ...
                        <>
                          <div className="col-span-1 mb-[0.2%] justify-between rounded-3xl bg-white py-10 px-[5%] text-left align-middle shadow-md hover:bg-indigo-100">
                            <LabelFieldPreview label="School:" field={elementary.schoolName ? elementary.schoolName : 'N/A'} />
                            <LabelFieldPreview label="Basic Education:" field={elementary.degree ? elementary.degree : 'N/A'} />
                            <LabelFieldPreview label="Year Started:" field={elementary.from ? elementary.from : 'N/A'} />
                            <LabelFieldPreview label="Year Ended:" field={elementary.to ? elementary.to : 'N/A'} />
                            <LabelFieldPreview label="Highest Level/Units Earned:" field={elementary.units ? elementary.units : 'N/A'} />
                            <LabelFieldPreview label="Year Graduated:" field={elementary.yearGraduated ? elementary.yearGraduated : 'N/A'} />
                            <LabelFieldPreview label="Academic Honors Received:" field={elementary.awards ? elementary.awards : 'N/A'} />
                          </div>
                        </>
                      )}
                    </>
                      ...
                      {secondary.schoolName === '' || secondary.schoolName === null ? (
                        ...
                        <>
                          <div className="col-span-1 mb-[0.2%] justify-between rounded-3xl bg-white py-10 px-[5%] text-left align-middle shadow-md hover:bg-indigo-100">
                            ...
                            <LabelFieldPreview label="Basic Education:" field={secondary.degree ? secondary.degree : 'N/A'} />
                            ...
                            <LabelFieldPreview label="Highest Level/Units Earned:" field={secondary.units ? secondary.units : 'N/A'} />
                            <LabelFieldPreview label="Year Graduated:" field={secondary.yearGraduated ? secondary.yearGraduated : 'N/A'} />
                            <LabelFieldPreview label="Academic Honors Received:" field={secondary.awards ? secondary.awards : 'N/A'} />
                          </div>
                        </>
                      )}
                    </>
                  ...
                  <CardContainer title="Vocational Education" titleSize="xl" titleClassName="font-medium" isArray cols={vocational.length}>
                    <>
                      {vocational.length === 0 ? (
                        <div className="shadow-sm rounded-3xl shadow-slate-200">
                          <NotApplicableVisual />
                          ...
                          {vocational.map((course: EducationInfo, courseIdx: number) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <LabelFieldPreview label="Year Ended:" field={isEmpty(to) && isEmpty(yearGraduated) ? 'Present' : 'N/A'} />
                                <LabelFieldPreview label="Highest Level/Units Earned:" field={units ? units : 'N/A'} />
                                <LabelFieldPreview label="Year Graduated:" field={yearGraduated ? yearGraduated : 'N/A'} />
                  ...
                  <CardContainer title="College Education" titleSize="xl" titleClassName="font-medium" isArray cols={college.length}>
                    <>
                      {college.length === 0 ? (
                        <div className="shadow-sm rounded-3xl shadow-slate-200">
                          <NotApplicableVisual />
                  ...
                  <CardContainer title="Graduate Education" titleSize="xl" titleClassName="font-medium" isArray cols={graduate.length}>
                    <>
                      {graduate.length === 0 ? (
                        <div className="shadow-sm rounded-3xl shadow-slate-200">
                          <NotApplicableVisual />
                  ...
                  {eligibility.length === 0 ? (
                    ...
                    <>
                      {eligibility.map((elig: Eligibility, eligIdx: number) => {
                        const { name, rating, examDateFrom, examDateTo, examPlace, licenseNumber, validity } = elig;
                        return (
                          <div
                            key={eligIdx}
                            className="col-span-1 mb-[0.2%] justify-between rounded-3xl bg-white py-10 px-[5%] text-left align-middle shadow-md hover:bg-indigo-100"
                          >
                            ...
                            <LabelFieldPreview label="Exam Date From:" field={examDateFrom ? examDateFrom : 'N/A'} />
                            <LabelFieldPreview label="Exam Date To:" field={examDateTo ? examDateTo : 'N/A'} />
                  ...
                  {workExperience.length === 0 ? (
                    ...
                    <>
                      {workExperience.map((work: WorkExperience, workIdx: number) => {
                        const { positionTitle, companyName, from, to, monthlySalary, isGovernmentService, salaryGrade, appointmentStatus } = work;
                        return (
                          <div
                            key={workIdx}
                            className="col-span-1 mb-[0.2%] justify-between rounded-3xl bg-white py-10 px-[5%] text-left align-middle shadow-md hover:bg-indigo-100 "
                          >
                            ...
                            <LabelFieldPreview
                              ...
                              field={isGovernmentService.toString() === 'true' ? 'Yes' : isGovernmentService.toString() === 'false' ? 'No' : 'N/A'}
                            />
                            <LabelFieldPreview label="Salary Grade:" field={salaryGrade ? salaryGrade : <span className="text-black">N/A</span>} />
                            <LabelFieldPreview label="Appointment Status:" field={appointmentStatus ? appointmentStatus : 'N/A'} />
                          </div>
                        );
                      })}
                    </>
                      ...
                      {voluntaryWork.map((work: VoluntaryWork, workIdx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <LabelFieldPreview label="Organization:" field={organizationName ? organizationName : 'N/A'} />
                            <LabelFieldPreview label="Date From:" field={from ? from : 'N/A'} />
                            <LabelFieldPreview label="Date To:" field={to ? to : 'N/A'} />
                    ...
                    <>
                      ...
                      <LabelQNA
                        ...
                        answer={
                          ...
                          (isEmpty(officeRelation.details) && officeRelation.withinFourthDegree.toString() === 'true') ? (
                  ...
                  <CardQuestion>
                    <>
                      <LabelQNA
                        ...
                        details1={
                          isEmpty(candidateResigned.candidateDetails) && candidateResigned.isCandidate.toString() === 'true' ? (
                            <span className="text-sm text-indigo-600">No answer provided</span>
                          ) : (
                      ...
                      <LabelQNA
                        ...
                        details1={
                          isEmpty(candidateResigned.resignedDetails) && candidateResigned.isResigned.toString() === 'true' ? (
                            <span className="text-sm text-indigo-600">No answer provided</span>
                          ) : (
                  ...
                  <CardQuestion mainQuestion="Pursuant to: (a) Indigenous People's Act (RA 8371); (b) Magna Carta for Disabled Persons (RA 7277); and (c) Solo Parents Welfare Act of 2000 (RA 8972), please answer the following items:">
                    <>
                      ...
                      <LabelQNA
                        ...
                        details1={
                          isEmpty(indigenousPwdSoloParent.pwdIdNumber) && indigenousPwdSoloParent.isPwd.toString() === 'true' ? (
                            <span className="text-sm text-indigo-600">No answer provided</span>
                          ) : (
                      ...
                      <LabelQNA
                        ...
                        details1={
                          isEmpty(indigenousPwdSoloParent.soloParentIdNumber) && indigenousPwdSoloParent.isSoloParent.toString() === 'true' ? (
                            <span className="text-sm text-indigo-600">No answer provided</span>
                          ) : (
                      ...
                      {references.map((reference: Reference, refIdx: number) => {
                        ...
                        return (
                          ...
                          >
                            <LabelFieldPreview
                              label="Name: "
                              field={name ? name : <span className="text-indigo-500 hover:text-indigo-900">No data provided</span>}
                            />
                            <LabelFieldPreview
                              label="Address: "
                              field={address ? address : <span className="text-indigo-500 hover:text-indigo-900">No data provided</span>}
                            />
                            <LabelFieldPreview
                              label="Telephone Number: "
                              field={
                                telephoneNumber ? telephoneNumber : <span className="text-indigo-500 hover:text-indigo-900">No data provided</span>
                              }
                            />
                          </div>
                        );
              ...
              <>
                <div className="px-5">
                  <CardPreview title="" subtitle="">
                    <>
                      <LabelFieldPreview label="Government ID: " field={governmentIssuedId.issuedId ? governmentIssuedId.issuedId : 'N/A'} />
                      <LabelFieldPreview label="ID number: " field={governmentIssuedId.idNumber ? governmentIssuedId.idNumber : 'N/A'} />
                      <LabelFieldPreview label="Issued Date: " field={governmentIssuedId.issueDate ? governmentIssuedId.issueDate : 'N/A'} />
                      <LabelFieldPreview label="Issued Place" field={governmentIssuedId.issuePlace ? governmentIssuedId.issuePlace : 'N/A'} />
                    </>
                  </CardPreview>
                </div>
              </>
