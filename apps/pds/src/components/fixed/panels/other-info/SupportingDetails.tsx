...
import { SupportingInfoAlert } from './SupportingInfoAlert';
...
export const SupportingDetails = (): JSX.Element => {
  ...
  const setInitialValues = () => {
    setOfficeRelation(initialPdsState.officeRelation);
    setGuiltyCharged(initialPdsState.guiltyCharged);
    setConvicted(initialPdsState.convicted);
    setSeparatedService(initialPdsState.separatedService);
    setCandidateResigned(initialPdsState.candidateResigned);
    setImmigrant(initialPdsState.immigrant);
    setIndigenousPwdSoloParent(initialPdsState.indigenousPwdSoloParent);
  };
