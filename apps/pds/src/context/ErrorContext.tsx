import { createContext, ReactNode, SetStateAction, useRef, useState } from 'react';
...
export const ErrorProvider = ({ children }: ErrorProviderProps) => {
  ...
  return (
    <>
      <ErrorContext.Provider value={{ resAddrError, setResAddrError, permaAddrError, setPermaAddrError, permaAddrRef, resAddrRef, shake, setShake }}>
        {children}
