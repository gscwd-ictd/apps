...
const ViewStationSsModal: FunctionComponent<ViewStationSsModalProps> = ({
  modalState,
  closeModalAction,
  setModalState,
  rowData,
  ...
  return (
    <>
      <Modal open={modalState} setOpen={setModalState} size="lg" steady>
        <Modal.Header>
          <h1 className="px-5 text-xl font-medium">View Station Scheduling Sheet</h1>
        </Modal.Header>
        <Modal.Body>
          {isLoading ? (
...
export default ViewStationSsModal;
