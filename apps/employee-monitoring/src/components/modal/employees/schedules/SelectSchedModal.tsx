...
type SelectSchedModalProps = {
  modalState: boolean;
  setModalState: Dispatch<SetStateAction<boolean>>;
  closeModalAction: () => void;
};

const SelectSchedModal: FunctionComponent<SelectSchedModalProps> = ({
  modalState,
  closeModalAction,
  setModalState,
}) => {
  ...
  return (
    <>
      <Modal open={modalState} setOpen={setModalState} steady size="sm">
        <Modal.Header>
          <h1 className="text-2xl font-medium">Select a Schedule</h1>
        </Modal.Header>
        <Modal.Body>
          {transformedScheds ? (
            <>
