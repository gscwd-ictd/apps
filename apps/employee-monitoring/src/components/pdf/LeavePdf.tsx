...
export const LeavePdf = ({ leaveDetails, selectedLeaveLedger, vlEntry, slEntry }: LeavePdfProps): JSX.Element => {
                                ...
                                {leaveDetails.leaveApplicationBasicInfo?.leaveName === LeaveName.MONETIZATION
                                  ? Number(
                                      parseFloat(`${vlEntry?.vacationLeaveBalance}`) +
                                        parseFloat(`${leaveDetails.leaveApplicationDetails?.convertedVl}`)
                                    ).toFixed(3)
                                  : leaveDetails.leaveApplicationBasicInfo?.leaveName === LeaveName.TERMINAL
                                  ? Number(
                                      parseFloat(
                                ...
                                {leaveDetails.leaveApplicationBasicInfo?.leaveName === LeaveName.MONETIZATION
                                  ? Number(
                                      parseFloat(`${slEntry?.sickLeaveBalance}`) +
                                        parseFloat(`${leaveDetails.leaveApplicationDetails?.convertedSl}`)
                                    ).toFixed(3)
                                  : leaveDetails.leaveApplicationBasicInfo?.leaveName === LeaveName.TERMINAL
                                  ? Number(
                                      parseFloat(
              ...
              <View style={styles.page}>
                ...
                >
                  ...
                  >
                    ...
                    <Text>
                      It shall be filed five (5) days in advance, whenever possible, of the effective date of such
                      leave. Vacation leave within in the Philippines or abroad shall be indicated in the form for
                      purpose of securing travel authority and completing clearance from money and work
                      accountabilities.
                    </Text>

                    <Text style={{ fontFamily: 'Helvetica-Bold', paddingTop: 8 }}>2. Mandatory/Forced leave*</Text>
                    <Text>
                      Annual five-day vacation leave shall be forfeited if not taken during the year. In case the
                      scheduled leave has been cancelled in the exigency of the service by the head of agency, it shall
                      no longer be deducted from the accumulated vacation leave. Availment of one (1) day or more
                      Vacation Leave (VL) shall be considered for complying the mandatory/forced leave subject to the
                      conditions under Section 25, Rule XVI of the Omnibus Rules Implementing E.O. No. 292.
                    </Text>
                    ...
                    <Text>
                      * If filed in advance or exceeding five (5) days, application shall be accompanied by a medical
                      certificate. In case medical consultation was not availed of, an affidavit should be executed by
                      an applicant.
                    </Text>
                    ...
                    <Text>
                      It shall be filed/approved for at least one (1) week prior to availment, except on emergency
                      cases. Special privilege leave within the Philippines or abroad shall be indicated in the form for
                      purposes of securing travel authority and completing clearance from money and work
                      accountabilities.
                    </Text>
                    ...
                    <Text>
                      c. If the protection order is not yet issued by the barangay or the court, a certification issued
                      by the Punong Barangay/Kagawad or Prosecutor or the Clerk of Court that the application for the
                      BPO, TPO or PPO has been filed with the said office shall be sufficient to support the application
                      for the ten-day leave; or
                    </Text>
                  </View>
                  ...
                  >
                    <Text>
                      d. In the absence of the BPO/TPO/PPO or the certification, a police report specifying the details
                      of the occurrence of violence on the victim and a medical certificate may be considered, at the
                    ...
                    <Text>
                      * Medical certificate on the nature of the injuries, the course of treatment involved, and the
                      need to undergo rest, recuperation, and rehabilitation, as the case may be.
                    </Text>
                    <Text>
                      * Written concurrence of a government physician should be obtained relative to the recommendation
                      for rehabilitation if the attending physician is a private practicioner, particularly on the
                      duration of the period of rehabilitation.
                    </Text>
                    ...
                    <Text>
                      * The application may be filed in advance, that is, at least five (5) days prior to the scheduled
                      date of the gynercological surgery that will be undergone by the employee. In case of emergency,
                      the application for special leave shall be filed immediately upon employee's return but during
                    ...
                    <Text>
                      * The application shall be accompanied by a medical certificate filled out by the proper medical
                      authorities, e.g. the attending surgeon accompanied by a clinical summary reflecting the
                      gynecological disorder which shall be addressed or was addressed by the said surgery; the
                      histopathological report; the operative technique used for the surgery; the duration of the
                      surgery including the perioperative period (period of confinement around surgery); as well as the
                    ...
                    <Text>
                      * The special emergency leave can be applied for a maximum of five (5) straight working days or
                      staggered basis within thirty (30) days from the actual occurence of the natural
                      calamity/disaster. Said privilege shall be enjoyed once a year, not in every instance of calamity
                      or disaster.
                    </Text>
                    <Text>
                      * The head of office shall take full responsibility for the grant of special emergency leave and
                      ...
                      verification that the place of residence is covered in the declaration of calamity area by the
                    ...
                    <Text>
                      Application for monetization of fifty percent (50%) or more of the accumulated leave credits shall
                      be accompanied by letter request to the head of the agency stating the valid and justifiable
                      reasons.
                    </Text>
