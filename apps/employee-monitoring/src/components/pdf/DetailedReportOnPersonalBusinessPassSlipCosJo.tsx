...
import { DetailedReportOnPbPassSlipCosJo } from '../../utils/types/report.type';
...
type DetailedReportOnPersonalBusinessPassSlipCosJoProps = {
...
export const DetailedReportOnPersonalBusinessPassSlipCosJoPdf: FunctionComponent<
  DetailedReportOnPersonalBusinessPassSlipCosJoProps
    ...
    <>
      {isClient && (
        <PDFViewer width={'100%'} height={1400}>
          <Document title="Detailed Report on Personal Business Pass Slip (COS/JO)">
            {/* FOLIO */}
            <Page size={[612.0, 936.0]} style={styles.page}>
              <View>
                ...
                <View style={[styles.w100, styles.horizontalCenter]} fixed>
                  <Text style={[styles.documentTitle]}>DETAILED REPORT ON PERSONAL BUSINESS PASS SLIP (COS/JO)</Text>
                ...
                <View style={styles.reportTable}>
                  ...
                  {/* DATA */}
                  {!isEmpty(detailedReportOnPbPassSlipCosJoDoc.report)
                    ? detailedReportOnPbPassSlipCosJoDoc.report?.map((pbPassSlipData, index) => {
                        return (
                          <View
                ...
                <View style={[styles.rowContainer, styles.signatoryContainer]}>
                  ...
                  <View style={[styles.w33_33]}>
                    ...
                    >
                      {detailedReportOnPbPassSlipCosJoDoc.signatory?.preparedBy.name}
                    </Text>
                    <Text style={[{ paddingTop: 2 }]}>
                      {detailedReportOnPbPassSlipCosJoDoc.signatory?.preparedBy.positionTitle}
                    </Text>
                  </View>
                  ...
                  <View style={[styles.w33_33]}>
                    ...
                    >
                      {detailedReportOnPbPassSlipCosJoDoc.signatory?.reviewedBy.name}
                    </Text>
                    <Text style={[{ paddingTop: 2, marginRight: 10 }]}>
                      {detailedReportOnPbPassSlipCosJoDoc.signatory?.reviewedBy.positionTitle}
                    </Text>
                  </View>
                  ...
                  <View style={[styles.w33_33]}>
                    ...
                    >
                      {detailedReportOnPbPassSlipCosJoDoc.signatory?.approvedBy.name}
                    </Text>
                    <Text style={[{ paddingTop: 2 }]}>
                      {detailedReportOnPbPassSlipCosJoDoc.signatory?.approvedBy.positionTitle}
                    </Text>
                  </View>
                </View>
...
export default DetailedReportOnPersonalBusinessPassSlipCosJoPdf;
