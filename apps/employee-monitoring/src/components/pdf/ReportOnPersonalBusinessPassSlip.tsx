...
import { ReportOnPersonalBusinessPassSlip } from '../../utils/types/report.type';
import { DateFormatter } from 'libs/utils/src/lib/functions/DateFormatter';
import { PdfHeader } from '@gscwd-apps/oneui';

type ReportOnPersonalBusinessPassSlipProps = {
  reportOnPersonalBusinessPassSlipData: ReportOnPersonalBusinessPassSlip;
};
...
export const ReportOnPersonalBusinessPassSlipPdf: FunctionComponent<ReportOnPersonalBusinessPassSlipProps> = ({
  reportOnPersonalBusinessPassSlipData,
}) => {
    ...
    <>
      {isClient && (
        <PDFViewer width={'100%'} height={1400}>
          <Document title="Report on Personal Business Pass Slip">
            {/* FOLIO */}
            <Page size={[612.0, 936.0]} style={styles.page}>
              <View>
                ...
                <View style={styles.reportTable}>
                  ...
                  {/* DATA */}
                  {!isEmpty(reportOnPersonalBusinessPassSlipData.report)
                    ? reportOnPersonalBusinessPassSlipData.report?.map((pbPassSlipData, index) => {
                        return (
                          <View
                ...
                <View style={[styles.rowContainer, styles.signatoryContainer]}>
                  ...
                  <View style={[styles.w33_33]}>
                    ...
                    >
                      {reportOnPersonalBusinessPassSlipData.signatory?.preparedBy.name}
                    </Text>
                    <Text style={[{ paddingTop: 2 }]}>
                      {reportOnPersonalBusinessPassSlipData.signatory?.preparedBy.positionTitle}
                    </Text>
                  </View>
                  ...
                  <View style={[styles.w33_33]}>
                    ...
                    >
                      {reportOnPersonalBusinessPassSlipData.signatory?.approvedBy.name}
                    </Text>
                    <Text style={[{ paddingTop: 2 }]}>
...
export default ReportOnPersonalBusinessPassSlipPdf;
